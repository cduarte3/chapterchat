  ...
  return (
    <>
      <div className="lg:max-w-[80%] max-w-[80%] mx-auto items-center h-full">
        <h1 className="font-black mt-[2%] p-5 text-center flex flex-col xl:text-7xl md:text-6xl sm:text-6xl text-4xl mx-auto justify-center text-[rgb(64,63,68)]">
        ...
        <div className="pt-20">
          ...
          <div className="md:pt-20 pt-10 flex-col grid grid-cols-2">
            <div className="flex justify-center md:justify-end md:pr-10">
                <Link to="https://github.com/cduarte3/chapterchat?tab=readme-ov-file#what-extra-features-will-be-added-soon" target="_blank">
